...
import "./MountainHeroWhisterBlackcomb.scss";

export default class MountainHeroWhisterBlackcomb extends React.Component {
  componentDidMount() {
    ...
    return (
      <section className="mountain-hero-whistler">
        <div className="mountain-hero-whistler__container nonparallax">
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--two parallax"
            data-speed="9"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--three parallax"
            data-speed="6"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--four parallax"
            data-speed="4"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--five parallax"
            data-speed="2"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--six parallax"
            data-speed="1"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
          ...
          <div
            className="mountain-hero-whistler__layer mountain-hero-whistler__layer--seven parallax"
            data-speed="1"
            style={{ transform: "translate3d(0px, 0px, 0px)" }}
          >
            {" "}
